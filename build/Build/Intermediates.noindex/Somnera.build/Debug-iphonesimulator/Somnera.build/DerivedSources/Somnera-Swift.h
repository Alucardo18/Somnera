...
#ifndef SOMNERA_SWIFT_H
#define SOMNERA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Somnera",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Somnera20AudioPlaybackService")
@interface AudioPlaybackService : NSObject
...
SWIFT_CLASS("_TtC7Somnera21SnoreDetectionService")
@interface SnoreDetectionService : NSObject <SNResultsObserving>
- (void)request:(id <SNRequest> _Nonnull)request didProduceResult:(id <SNResult> _Nonnull)result;
- (void)request:(id <SNRequest> _Nonnull)request didFailWithError:(NSError * _Nonnull)error;
